...
export const demosK: Demo[] = [
  {
    ...
    technique: ['JSON → --v per bar (value ÷ scale top)', 'scaleY walls + translateY lid, transitioned', 'staggered transition-delay: calc(var(--i) × 60ms)', 'see-through faces, bright edge + inset glow: the neon look'],
  },
  {
    id: 'heatmap',
