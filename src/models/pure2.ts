...
export const pureDemos2: Demo[] = [
  {
    ...
    html: `<div class="d-pyramid">${rep(4, () => '<i></i>')}<b></b><u></u></div>`,
  },
  {
    id: 'cylinder',
    title: 'Cylinder',
    description: 'A glass tube with rings of light rising inside. CSS has no curves in 3D, so the tube is 24 flat strips; Sass computes their width.',
    category: 'css',
    tags: ['loop', 'shape'],
    technique: ['strip width = 2r × tan(180° / n)', 'rotateY + translateZ', 'per-strip shading'],
    html: `<div class="d-cylinder">${rep(24, (i) => `<i style="--i:${i}"></i>`)}<b></b><s></s><u></u><u></u><u></u></div>`,
  },
  {
    id: 'coin',
    title: 'Spinning coin',
