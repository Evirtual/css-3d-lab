...
@keyframes wave {
  ...
  net: {
    how: [
      ...
      'The base turns a full circle between 8% and 92% of the loop (<code>0%, 8%</code> and <code>92%, 100%</code> hold the same angle, 360° apart). It eases in and out, so most of the turn happens while the cube is shut: every side gets seen, and the net always opens the same way round.',
